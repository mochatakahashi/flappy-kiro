...
- [x] 1. Set up project structure and configuration
  - [x] 1.1 Create project scaffolding and config module
  ...
  - [x] 1.2 Implement Ghost module (`src/ghost.js`)
  ...
  - [x] 1.3 Write property tests for Ghost physics
...
- [x] 2. Implement Pipe and Cloud systems
  - [x] 2.1 Implement Pipe Manager (`src/pipes.js`)
  ...
  - [x] 2.2 Write property tests for Pipe system
  ...
  - [x] 2.3 Implement Cloud Manager (`src/clouds.js`)
  ...
  - [x] 2.4 Write property test for Cloud speed invariant
    - **Property 13: Cloud speed invariant**
    - **Validates: Requirements 7.2**

- [x] 3. Implement Collision Detection and Scoring
  - [x] 3.1 Implement Collision Detection (`src/collision.js`)
  ...
  - [x] 3.3 Implement Score Manager (`src/scoring.js`)
...
- [x] 5. Implement Audio, Input, and Renderer
  - [x] 5.1 Implement Audio Manager (`src/audio.js`)
  ...
  - [x] 5.2 Implement Input Handler (`src/input.js`)
  ...
  - [x] 5.3 Implement Renderer (`src/renderer.js`)
...
- [x] 6. Implement Game Controller and State Machine
  - [x] 6.1 Implement Game Controller (`src/game.js`)
  ...
  - [x] 6.2 Write property test for restart delay guard
    - **Property 14: Restart delay guard**
    - **Validates: Requirements 6.5**

  - [x] 6.3 Implement responsive canvas scaling
  ...
  - [x] 6.4 Write property test for canvas scaling
    - **Property 15: Canvas scaling preserves aspect ratio**
    - **Validates: Requirements 9.2**

- [x] 7. Integration and final wiring
  - [x] 7.1 Wire all modules together in index.html
